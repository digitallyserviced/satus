...
const SelectItem = ({ children, ...props }) => {
  return (
    <SelectPrimitive.Item
      className="text-[13px] leading-none rounded-[3px] flex items-center h-[25px] pr-[35px] pl-[25px] relative SelectPrimitive-none data-[disabled]:pointer-events-none data-[highlighted]:outline-none"
      {...props}
    >
